...
**Task** Run the following code and describe the dataframe it outputs. **Answer:** The chart shows 50 states with their gdp growth, population change and spending per pupil.
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer:**Doesn\'t seem to be a very strong correlation. The data is pretty scattered everywhere, despite the small concentration near the line
...
**Task** Run the following code. Describe the plot. What do you see? **Answer:** there is a scattered plot with no pattern or trend. The line is negative, but slightly.
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer:** Now there is a table of the number of the correlations. There is a slightly negative correlation of gp growth and per pupil. Stronger negative pop change and per pupil.
...
**Task** Run the following code. Describe the model output. What do you see? **Answer:** The more of one thing, the less of another. This tells us whether or not the numbers are statistically significant according to the 0.05 recommendations
...
**Task** Run the following code. Describe the model output. What do you see? **Answer:** Correlation = is not statistically significant
...
**Task** Run the following code. Describe the table. What do you see? **Answer:** There is numeral and categorical data in the chart. By groupingthe 2020 votes and viewing the averages of gdp growth, per_pupil, and population change, we see which candidate won for gdp, money spent, and population growth. On average biden states had more gdp growth but it grew less on population.
...
**Task** Run the following code. Describe the output. What do you see? **Answer:** The data is not statistically significant because the p value is 0.07
...
**Task** Run the following code. Describe the output. What do you see? **Answer:** There is something statistically significant in this data because the p-value is 0.00.

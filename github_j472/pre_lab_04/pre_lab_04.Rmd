...
**Task** Run the following code to group and count records in the Grantee column, and filter to examine only recipients that start with W. Name a problem that you see that is preventing proper grouping. **Answer:** When you examine only recipients that start with W, you are going to get all of the grantees that start with W. This includes upper and lowercase W's. This might prevent proper grouping if one is more preferred than the other.
...
**Answer:** Washington County Museum of Fine Arts is all capitalized in grantee_clean but not in grantee. Charles County Arts Alliance Inc. is not all capitalized in grantee, but all capitalized in grantee_clean. The Tree House Child Advocacy Center of Montgomery County MD Inc. this is also not all capitalized in grantee but is all capitalized in grantee_clean.
...
**Task** Run the following code to group by grantee_clean and Grantee, then filter for recipients that start with W. Name three changes the refinr function made in the first 30 results. **Answer:** WASHINGTON ADVENTIST UNIVERSITY is now all lowercase, aside from the beginning letters of the words, in the grantee_clean column. The same for the Washington College. WASHINGTON CO COMM. ACTION COUNCIL IC, does not have a period in the grantee_clean column. WASHINGTON COUNTY COMMISSON ON AGING is lowercase in grantee_clean.
...
The two columns are the same aside from a few capitalization differences.

...
**Q1.** How many departments have offered the courses with "Climate" in the title and at least one seat? Which department has offered the most? **A1:** There are 20 departments that offer courses with "Climate" in the title. Atmospheric and Oceanic Science offers the most with 68 classes.
...
**Q2.** Of the departments listed in A1, which one is the most interesting to you, and why? **A2:** The most interesting one to me is Anthropology. I don't know much about that department so I am curious how climate is involved in it.
...
umd_courses |> 
  filter(str_detect(title, "Communication"))
    group_by( title)|>
   summarise( title)|>

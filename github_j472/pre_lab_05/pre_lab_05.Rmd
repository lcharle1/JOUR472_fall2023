...
```{r}
voters_by_county <- read_csv("tabula_Eligible_Active Voters_by_County - GG22.csv")
...
**Task** Load the data without headers by running the codeblock below. What problems remain? **Answer:** It says clean_names cannot be found.

```{r}
fentanyl_deaths <- read_csv("tabula_Annual_2020_Drug_Intox_Report.csv", col_names = FALSE) |> clean_names()
...
**Task** Run the codeblock below. What else do we need to do? **Answer:** Here we replaced all the column digits with numbers.

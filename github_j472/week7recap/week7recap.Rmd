...
**A1:** the csv includes a link instead of a data file
...
**A2:** There are 9777 observations and the columns describe each earthquake or quarry blast.
...
**A3:** The deepest earthquake is at 669.9820 with a magnitude of 4.20
...
**A8:** earthquake, 9541, and quarry blast, 129.
...
**A9:** earthquakes have a positive average depth. Does that mean earthquakes can occur above ground?
...
```{r}
What are the different places listed where the tremors were detected?
```

```{r}
Arrange the time in 12hr format. 
```

```{r}
What is the average time frame that tremors occur?
```
